# EchoNet Production Setup

## Ownership and Runtime Status

`src/production` is the current production runtime boundary for EchoNet.
...
The echo _production_ directory contains all the core production components of the echo system. These components can be instantiated locally on your developer machine using docker. When the echo components are instantiated in this way, the project echo team call this the **'EchoNet'** environment. Within Docker, a private network is setup called EchoNet and all the component containers join this network.
...
5. Open your terminal in your miniconda3/Anaconda environment and use the command line to move to the production directory

```
cd Project-Echo\src\production
```
...
<img src="https://github.com/DataBytes-Organisation/Project-Echo/blob/main/src/production/DockerContainers.png?raw=true" width="450" height=auto>
<br/><br/>
...
12. Restart Docker Desktop and from the production folder in terminal run:
