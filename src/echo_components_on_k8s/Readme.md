...
Owner: Backend for Kubernetes API deployment support and MongoDB deployment
assets. HMI owns the duplicated frontend source. Engine owns model and engine
runtime configuration.

Status: deployment variant, not the canonical source tree.
...
- Hard-coded database credentials and service URLs are tracked in
  `docs/backend-deployment-infrastructure-audit.md`.
